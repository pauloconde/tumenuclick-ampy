/**
 * DesktopCartSidebar - Fixed sidebar for desktop showing cart (POS style)
 */
...
export default function DesktopCartSidebar({ currency, phone, restaurantName, whatsappButtonText = 'Enviar por WhatsApp', whatsappFooterText, logoUrl, fulfillmentConfig }: DesktopCartSidebarProps) {
    ...
    // El sidebar siempre está abierto en desktop — agregar clase en mount
    React.useEffect(() => {
        document.body.classList.add('desktop-cart-open');
        return () => {
            document.body.classList.remove('desktop-cart-open');
        };
    }, []);
        ...
        <>
            <motion.aside
                ...
                className="
                    ...
                    border-l border-[var(--color-extras-border)]
                    flex-col
                    z-40
            ...
            >
                {/* Header */}
                <div className="flex items-center justify-between p-4 border-b bg-[var(--color-cart-header-bg)] border-[var(--color-extras-border)]">
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-3">
                    ...
                    {isEmpty && (
                        <div className="flex flex-col items-center justify-center h-full text-[var(--color-cart-empty-text)]/40">
                ...
                {/* Footer */}
                {!isEmpty && (
                    <div className="p-4 border-t border-[var(--color-extras-border)] space-y-4">
                        {/* Total */}
                        <div className="flex justify-between items-center">
                            <span className="text-lg text-[var(--color-cart-total-price)]/70">Total</span>
