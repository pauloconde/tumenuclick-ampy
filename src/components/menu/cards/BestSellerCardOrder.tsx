...
export default function BestSellerCardOrder({
    item,
    currencySymbol,
    priceDivider,
    ...
    const hasExtras = (item.variantGroups && item.variantGroups.length > 0) || (item.optionGroups && item.optionGroups.length > 0) || (item.extras && item.extras.length > 0);
                    ...
                    {quantityInCart > 0 && !(item.price2 || item.price3 || hasExtras) ? (
                        ...
                        <motion.button
                            ...
                            className="
                                ...
                                hover:bg-[var(--color-bestsellers-card-bg)]
